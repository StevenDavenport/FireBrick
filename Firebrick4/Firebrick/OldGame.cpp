...
//
//// Cast Special Ability 
//void OldGame::CastOnPlaySpecialAbility()
//{				
...
//
//// Prints table
//void OldGame::PrintCardsOnTable()
//{							
...
//		{
//			mPlayers[mFriendlyIndex]->IncreaseCardAttack(i, 1 * hordeCount);
//			std::cout << mFriendlyField[i].name << " increases it's attack by one" << std::endl;
//		}
//	}
//}
//
//void OldGame::CastTrample(const int& i)
//{
